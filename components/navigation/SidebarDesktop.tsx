  ...
  return (
    ...
    >
      <div className="h-full p-3">
        <div className="h-full rounded-2xl border border-white/20 bg-white/55 backdrop-blur-[18px] shadow-[var(--shadow-elev-1)] flex flex-col overflow-hidden" style={{ "--glass-blur-scrolled": `${blur}px` } as React.CSSProperties}>
          {/* Top */}
